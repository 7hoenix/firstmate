...
# hand-edit backlog files too, and primary config/workspace-setup.json makes a
# secondmate's own crewmate worktrees come up with the same per-project setup).
#
...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness backlog-backend workspace-setup.json}"
